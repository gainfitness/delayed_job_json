...
This is a hack of the 2.1.4 delayed_jobs to use json instead of yaml.  The job objects needs an inflate class method to reconstruct the object from a hash.
...
class NewsletterJob < Struct.new(:text, :emails)
  ...
  def self.inflate(hash)
    new(hash["text"],hash["emails"])
  end
end
